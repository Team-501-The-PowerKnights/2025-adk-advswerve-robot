...
public class DriveConstants {
  public static final double maxSpeedMetersPerSec = 5.74;
  public static final double odometryFrequency = 100.0; // Hz
  public static final double trackWidth = Units.inchesToMeters(23.96875);
  public static final double wheelBase = Units.inchesToMeters(23.90625);
